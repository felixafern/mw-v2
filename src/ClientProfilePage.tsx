...
export default function ClientProfilePage({ client, onBack }: { client: Client; onBack: () => void }) {
  ...
  const [holdingsTab, setHoldingsTab] = useState<'assets' | 'liabilities'>('assets')
            ...
            <div className="ds-card">
              ...
              <div style={{ padding: '4px 18px 10px' }}>
                {activeMember === 'household' ? (
                  ...
                  <>
                    <PersonalRow label="Age & DOB" icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>}>{md.age} · {md.dob}</PersonalRow>
                    <PersonalRow label="Occupation" icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg>}>{md.occupation}</PersonalRow>
                    <PersonalRow label="Income" icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>}>{md.income}</PersonalRow>
                    <PersonalRow label="ID Expiry" icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>}>
                      {activeMember === 'primary' && md.idExpiry === 'Jan 2026'
                        ? <span style={{ display: 'flex', alignItems: 'center', gap: 6, color: 'var(--danger)' }}><span style={{ width: 6, height: 6, borderRadius: '50%', background: 'var(--danger)', display: 'inline-block', flexShrink: 0 }} />{md.idExpiry}</span>
                        : md.idExpiry ?? '—'}
                    </PersonalRow>
                    <PersonalRow label="Marital Status" icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>}>{md.maritalStatus}</PersonalRow>
                    {md.children && <PersonalRow label="Children" icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>}>{md.children}</PersonalRow>}
                  </>
                )}
              </div>
            </div>
